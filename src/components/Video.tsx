...
import { CaretRight, DiscordLogo, FileArrowDown, Lightbulb, Lightning } from "phosphor-react";
    ...
    return (
        <div className="flex-1">
            ...
            <div className="bg-black flex justify-center">
                <div className="h-full w-full max-h[1100px] max-h[60vh] aspect-video">
            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                    ...
                    <div className="flex-1">
                        ...
                        {data.lesson.teacher && (
                            <div className="flex items-center gap-4 mt-6">
                                ...
                                <img 
                                    className="h-16 w-16 rounded-full borde-2 border-blue-500"
                ...
                <div className="gap-8 mt-20 grid grid-colors-2">
